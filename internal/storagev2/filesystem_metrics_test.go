...
func TestGetFilesystemMetricsWithConfig(t *testing.T) {
	...
	assert.GreaterOrEqual(t, metrics.CreateDirCount, int64(0))
	assert.GreaterOrEqual(t, metrics.DeleteDirCount, int64(0))
	assert.GreaterOrEqual(t, metrics.DeleteFileCount, int64(0))
	assert.GreaterOrEqual(t, metrics.MoveCount, int64(0))
	assert.GreaterOrEqual(t, metrics.CopyFileCount, int64(0))
