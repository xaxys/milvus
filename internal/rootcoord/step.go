...
func (s *DeleteCollectionMetaStep) Execute(ctx context.Context) error {
	return s.core.MetaTable.DeleteCollection(s.CollectionId, s.Timestamp)
}
...
func (s *DisableCollectionMetaStep) Execute(ctx context.Context) error {
	return s.core.MetaTable.DisableCollection(s.CollectionId)
}
...
func (s *AddCollectionMetaStep) Execute(ctx context.Context) error {
	return s.core.MetaTable.AddCollection(s.coll)
}
...
func (s *EnableCollectionMetaStep) Execute(ctx context.Context) error {
	return s.core.MetaTable.EnableCollection(s.CollectionId)
}
...
func (s *DeletePartitionMetaStep) Execute(ctx context.Context) error {
	return s.core.MetaTable.DeletePartition(s.CollectionId, s.PartitionId, s.Timestamp)
}
...
func (s *DisablePartitionMetaStep) Execute(ctx context.Context) error {
	return s.core.MetaTable.DisablePartition(s.CollectionId, s.PartitionId)
}
...
func (s *AddPartitionMetaStep) Execute(ctx context.Context) error {
	return s.core.MetaTable.AddPartition(s.CollectionId, s.PartInfo.PartitionName, s.PartInfo.PartitionID, s.Timestamp)
}
...
func (s *EnablePartitionMetaStep) Execute(ctx context.Context) error {
	return s.core.MetaTable.EnablePartition(s.CollectionId, s.PartitionId)
}
