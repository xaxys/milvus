...
DECLARE_PROMETHEUS_COUNTER(internal_storage_op_count_get_total);
...
DECLARE_PROMETHEUS_COUNTER(internal_storage_op_count_put_total);
...
DECLARE_PROMETHEUS_COUNTER(internal_storage_op_count_stat_total);
...
DECLARE_PROMETHEUS_COUNTER(internal_storage_op_count_list_total);
...
DECLARE_PROMETHEUS_COUNTER(internal_storage_op_count_remove_total);

DECLARE_PROMETHEUS_GAUGE_FAMILY(internal_storage_in_flight);
DECLARE_PROMETHEUS_GAUGE(internal_storage_in_flight_get);
DECLARE_PROMETHEUS_GAUGE(internal_storage_in_flight_put);
DECLARE_PROMETHEUS_GAUGE(internal_storage_in_flight_stat);
DECLARE_PROMETHEUS_GAUGE(internal_storage_in_flight_list);
DECLARE_PROMETHEUS_GAUGE(internal_storage_in_flight_remove);
