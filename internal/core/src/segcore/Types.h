...
struct LoadIndexInfo {
    ...
    // Exact total size of the serialized remote index objects. Zero means the
    // producer did not provide it. This is intentionally separate from
    // index_size, which remains the resource-planning estimate above.
